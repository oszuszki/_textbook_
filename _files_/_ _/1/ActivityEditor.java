...
class FileTree extends javafx.scene.control.TreeView<java.io.File> {
 ...
 //                           = new javafx.scene.control.TreeItem<java.io.File>(f, new javafx.scene.image.ImageView(actIcon));
            ...
            propsMenuItem.setOnAction((javafx.event.ActionEvent evt) -> {
                ...
                System.out.println("Adja meg az új altevékenység tulajdonság nevét: ");
                Scanner file_nevi1 = new Scanner(System.in);
                String file_nev1 = file_nevi1.next();

                java.io.File f = new java.io.File(file.getPath() + System.getProperty("file.separator") + file_nev1);
